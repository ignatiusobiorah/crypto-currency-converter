      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-start">
          ...
          <div className="flex justify-center space-x-6 mt-4 md:mt-0">
            <a href="#about" className="text-sm text-gray-300 hover:text-orange-500">About Us</a>
            <a href="#contact" className="text-sm text-gray-300 hover:text-orange-500">Contact</a>
            <a href="#support" className="text-sm text-gray-300 hover:text-orange-500">Support</a>
            <a href="#privacy" className="text-sm text-gray-300 hover:text-orange-500">Privacy Policy</a>
          </div>
        </div>
